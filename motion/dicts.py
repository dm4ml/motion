...
# STATE_ERROR_MSG = (
#     "Cannot edit state directly. Use component update operations instead."
# )
...
#             1000
#             * 60
#             * 2,  # 2 minutes lock duration TODO: make this configurable
#             redis_host,
#             redis_port,
#             redis_db,
#             redis_password,
...
#     def flushUpdateDict(
#         self, update_dict: dict, from_migration: bool = False
#     ) -> None:
